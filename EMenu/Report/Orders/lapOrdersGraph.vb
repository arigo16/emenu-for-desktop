...
Public Class lapOrdersGraph
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMenu.lapOrdersGraph.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedlapOrdersGraph
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lapOrdersGraph = New lapOrdersGraph()
        rpt.Site = Me.Site
        Return rpt
    End Function
