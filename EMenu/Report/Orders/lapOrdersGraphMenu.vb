...
Public Class lapOrdersGraphMenu
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMenu.lapOrdersGraphMenu.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedlapOrdersGraphMenu
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lapOrdersGraphMenu = New lapOrdersGraphMenu()
        rpt.Site = Me.Site
        Return rpt
    End Function
