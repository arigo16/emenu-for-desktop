...
Public Class lapPaymentsGraph
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EMenu.lapPaymentsGraph.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedlapPaymentsGraph
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lapPaymentsGraph = New lapPaymentsGraph()
        rpt.Site = Me.Site
        Return rpt
    End Function
